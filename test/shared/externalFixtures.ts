...
} from '@surge/surge-core/artifacts/contracts/Factory.sol/Factory.json'
import { abi as FACTORY_V2_ABI, bytecode as FACTORY_V2_BYTECODE } from '../../contracts/abi/UniswapV2Factory.json'
...
} from '@surge/v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
